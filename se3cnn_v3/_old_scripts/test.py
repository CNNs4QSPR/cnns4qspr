...
# python test.py --model SE3ResNet34Small --data-filename cath_3class.npz --training-epochs 100 --batch-size 10 --batchsize-multiplier 1 --kernel-size 3 --initial_lr=0.1 --lr_decay_base=.996 --p-drop-conv 0.1 --downsample-by-pooling
